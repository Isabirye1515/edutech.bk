...
public class AddressDao {
  ...
  public List<Address> getAllAddresses() {
    ...
    List<Address> addresses = entityManager.createQuery(sql, Address.class).getResultList();
    return addresses;
  }
  ...
  public Address getAddressById(int id) {
    ...
    Address address =
        entityManager.createQuery(sql, Address.class).setParameter("id", id).getSingleResult();
    return address;
  }
