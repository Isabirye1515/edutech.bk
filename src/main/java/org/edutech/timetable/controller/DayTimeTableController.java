...
public class DayTimeTableController {
  ...
  @Autowired private DayTimeTableService dayTimeTableService;
  ...
  @PutMapping("/{id}")
  public ResponseEntity<DayTimeTable> updateDayTimeTable(
      @PathVariable int id, @RequestBody DayTimeTable updated) {
