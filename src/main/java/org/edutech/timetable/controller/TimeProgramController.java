...
public class TimeProgramController {
  ...
  @Autowired private TimeProgramService timeProgramService;
  ...
  @PutMapping("/{id}")
  public ResponseEntity<TimeProgram> updateTimeProgram(
      @PathVariable int id, @RequestBody TimeProgram updatedProgram) {
