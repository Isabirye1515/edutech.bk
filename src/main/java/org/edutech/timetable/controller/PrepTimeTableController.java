...
public class PrepTimeTableController {
    ...
    @Autowired
    private PrepTimeTableService prepTimeTableService;

    // Create a new PrepTimeTable
    @PostMapping
    public ResponseEntity<PrepTimeTable> createPrepTimeTable(@RequestBody PrepTimeTable prepTimeTable) {
    ...
    public ResponseEntity<PrepTimeTable> updatePrepTimeTable(
            @PathVariable int id,
            @RequestBody PrepTimeTable updatedTable) {
