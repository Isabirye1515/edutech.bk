...
public class WeekendTimeTableController {
  ...
  @Autowired private WeekendTimeTableService weekendTimeTableService;

  // Create a new weekend timetable
  @PostMapping
  public ResponseEntity<WeekendTimeTable> createWeekendTimeTable(
      @RequestBody WeekendTimeTable weekendTimeTable) {
  ...
  public ResponseEntity<WeekendTimeTable> updateWeekendTimeTable(
      @PathVariable int id, @RequestBody WeekendTimeTable updatedTable) {
