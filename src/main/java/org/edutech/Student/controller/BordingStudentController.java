...
public class BordingStudentController {
  ...
  @Autowired private BordingStudentService service;
  ...
  @PutMapping("/{id}")
  public ResponseEntity<String> updateBordingStudent(
      @PathVariable int id, @RequestBody BordingStudent updated) {
